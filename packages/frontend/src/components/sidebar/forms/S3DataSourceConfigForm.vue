  ...
  <div class="grid grid-cols-2 gap-3">
    ...
    <div class="flex flex-col gap-2">
      ...
      <Password
        ...
        toggle-mask
        :feedback="false"
        :placeholder="props.redactedSecretFields?.includes('secretKey') ? 'Saved secret' : ''"
      />
    </div>
  </div>
  ...
  <div class="grid grid-cols-2 gap-3">
    <div class="flex flex-col gap-2">
      ...
      <Password
        ...
        toggle-mask
        :feedback="false"
        :placeholder="props.redactedSecretFields?.includes('sessionToken') ? 'Saved token' : 'Optional'"
      />
    </div>
    <div class="flex flex-col gap-2">
