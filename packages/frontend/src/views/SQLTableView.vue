...
import { buildTableQuery, normalizeWhereClause } from '@/utils/sql-table-query'
...
const serializeRowForSave = (rowValues: Record<string, unknown>) =>
  Object.fromEntries(columns.value.map((column) => [column.field, normalizeCellValue(column, rowValues[column.field])]))
  ...
  <div class="flex flex-col w-full h-full">
    ...
    >
      ...
      <div class="flex items-center gap-2 ml-auto">
        <span class="text-xs uppercase tracking-[0.16em] opacity-55 mono">Page size</span>
        <Select
    ...
    <div v-else class="border-b border-neutral-200 dark:border-neutral-800 overflow-hidden h-full min-h-0">
